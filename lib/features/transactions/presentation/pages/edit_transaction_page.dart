            ...
            child: Column(
              ...
              children: [
                ...
                categoriesAsync.when(
                  data: (list) {
                    // Make sure the preselected category ID exists in list, otherwise default to list.first
                    final categoryExists = list.any((c) => c.id == _selectedCategoryId);
                    if (!categoryExists && list.isNotEmpty) {
